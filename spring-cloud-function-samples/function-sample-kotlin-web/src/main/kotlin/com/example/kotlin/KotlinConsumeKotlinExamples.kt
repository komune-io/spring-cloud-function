 ...
 * --- Coroutine ---
 * 1. (T) -> Unit                 -> consumerKotlinSingle
 * 2. (Flow<T>) -> Unit           -> consumerKotlinFlow
 * 3. suspend (T) -> Unit         -> consumerKotlinSuspendSingle
...
@Component
class ConsumerKotlinSingle : (String) -> Unit {
...
/** 1) (T) -> Unit */
@Component
class ConsumerKotlinSingleBean : (String) -> Unit {
	override fun invoke(input: String) {
		println("Consumed: $input")
	}
}
...
/** 3) suspend (T) -> Unit */
@Component
class ConsumerKotlinSuspendSingle : suspend (String) -> Unit {
